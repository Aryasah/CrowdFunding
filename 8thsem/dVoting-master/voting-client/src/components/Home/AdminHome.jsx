    ...
    <Section id="form">
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex flex-row items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="flex flex-1 justify-center h-full items-center p-8 lg:p-16 mb-10 border border-n-1/10 rounded-3xl">
              ...
              >
                <div className={`max-w-[50rem] mx-auto text-left w-full`}>
                  ...
                  {<p className="body-2 mt-1 mb-4 text-n-4 text-sm">Your account</p>}
                </div>
